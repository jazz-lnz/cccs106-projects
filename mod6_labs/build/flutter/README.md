...
* `mod6_labs` - project name - lowercase, no spaces, i.e. "snake_case" identifier - used as a package name, iOS/macOS/Android bundle name and Windows/Linux executable file name.
* `` - project description.
* `mod6_labs` - project display name that is shown in window titles and about app dialogs.
